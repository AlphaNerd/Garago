angular.module('garago.controllers.activities', [])
    ...
    .controller('ActivitiesCtrl', function (
        ...
        console.log("Activities Controller Loaded")
        ...
        ACTIVITIES.on('open', function () {
            console.log('subscription opened for ACTIVITIES');
        });
        ...
        $scope.createNewActivity = function () {
            ...
            Parse.Cloud.run('createNewActivity', {
