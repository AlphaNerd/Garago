<div class="comments index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ref_cellule'); ?></th>
			<th><?php echo $this->Paginator->sort('email_send'); ?></th>
			<th><?php echo $this->Paginator->sort('nom'); ?></th>
			<th><?php echo $this->Paginator->sort('date_send'); ?></th>
			<th><?php echo $this->Paginator->sort('organisation'); ?></th>
			<th><?php echo $this->Paginator->sort('message'); ?></th>
			<th><?php echo $this->Paginator->sort('email_recive'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($comments as $comment): ?>
	<tr>
		<td><?php echo h($comment['Comment']['id']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['plan_id']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['ref_cellule']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['email_send']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['nom']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['date_send']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['organisation']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['message']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['email_recive']); ?>&nbsp;</td>
		<td class="actions">
